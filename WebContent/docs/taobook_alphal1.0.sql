...
CREATE TABLE `sys_menu` (
  ...
  `leaf` bigint(1) NOT NULL DEFAULT '0' COMMENT '是否子菜单',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;

/*Data for the table `sys_menu` */

insert  into `sys_menu`(`id`,`menuId`,`text`,`parentId`,`iconCls`,`qtip`,`leaf`) values (1,'userManage','用户管理','top','icon-user','用户管理',0),(2,'userAdd','新增用户','userManage','icon-add','新增用户',1),(3,'userUpdate','修改用户','userManage','icon-edit','修改用户',1);
